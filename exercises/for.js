...
let palabras = ["Este", "es", "un", "proyecto", "JavaScript"];
for (let i = 0; i < palabras.length; i++) {
    alert(palabras[i]);
}

// Ejercicio b: Al array anterior convertir la primera letra de cada palabra en mayúscula y
...
// Ejercicio c: Crear una variable llamada “sentence” que tenga un string vacío, luego al array
...
alert(sentence.trim());  // trim() para eliminar el espacio extra al final

// Ejercicio d: Crear una array vacío y con un bucle for de 10 repeticiones. Llenar el array con
